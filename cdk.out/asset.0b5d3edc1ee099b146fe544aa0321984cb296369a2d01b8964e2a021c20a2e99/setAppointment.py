...
appointment_table = os.environ["appointmentTable"]
...
def lambda_handler(event, context):
    ...
    appointmentItem = appointmentObj.getAmenitiesInfo()
    try:
        ...
        return returnResponse(400, "Something went wrong with setAppointment")
