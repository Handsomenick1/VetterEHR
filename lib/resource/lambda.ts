...
export function createAppointmentLambda(stack: Stack, funcName: string, handlerPath: string, layersName1: string, environVars: {}): lambda.Function{
    let lambdaFunction = new lambda.Function(stack, funcName, {
        ...
        layers: [lambda.LayerVersion.fromLayerVersionAttributes(stack, layersName1, {
            layerVersionArn: "arn:aws:lambda:us-west-2:568187732893:layer:jwt:1",
